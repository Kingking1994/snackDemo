...
public class SnakeView extends TileView {
    ...
    //定义MP3播放器
    MediaPlayer eatMP,startMP,endMP;
    ...
    private long mMoveDelay = 500;  //每移动一步的延时。初始时设置为500ms，以后每吃一个果子，打个折
               					//造成的结果是速度越来越快。
    private double increaseRate = 0.9;
   ...
   //判断当前是否处于危险状态，就是撞墙或者 撞自己
    //然后处于这个状态的时候，设置500ms的判断时间，如果
    //在这个时间内做出有效动作，那么危险解除，设置为false
    private boolean isdangerous =false;
    private int judgetime = 500; 
    ...
    private Point startPoint,endPoint;//获得手指在屏幕上的点
    ...
    private void initSnakeView() {
    	...
    	endMP = MediaPlayer.create(getContext(), R.raw.end);
        eatMP = MediaPlayer.create(getContext(), R.raw.eat);
        startMP = MediaPlayer.create(getContext(), R.raw.start);
...
//        mShitList = coordArrayToArrayList(icicle.getIntArray("mShitList"));
    ...
    public void setSound(boolean flag){//设置是否开启音效
    	sound_on = flag;
    }
    ...
    public void setMode(int newMode) {
        ...
        if (newMode == RUNNING & oldMode != RUNNING) {
            ...
            try {
				...
				e.printStackTrace();
			} //注意到，在initGame中也有update(),不过放心～ 多次重复 update不会影响效果的，
     ...
     * 
     */
    private void updateSnake() throws Throwable {//至于这里为什么用throwable，我也不知道
    ...
    //游戏状态检查，并且开始游戏
    public void gamestateCheck() throws IllegalStateException, IOException{
